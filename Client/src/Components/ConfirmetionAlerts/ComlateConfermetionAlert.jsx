...
function CompleteConfirmationAlert({
                                       showConfirm,
                                       setShowConfirm,
                                       completeId,
                                       setCompleteId,
    ...
    return (
        showConfirm && (
            ...
            >
                <div className={`bg-gradient-to-br from-green-800 to-emerald-900/80 backdrop-blur-md rounded-xl shadow-lg border border-white/10 w-11/12 max-w-md ${closing ? 'transform -translate-y-full' : 'transform translate-y-0'} transition-transform duration-400 ease-in-out relative overflow-hidden`}>
                    {/* Close Button (X) */}
                    <button
                        onClick={handleClose}
...
export default CompleteConfirmationAlert;