...
function Footer() {
    ...
    return (<>
        <footer className="text-gray-600 body-font">
            <div
                className="container px-5 pt-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
                            ...
                            {loggedin && <>
                                ...
                                <li>
                                    <a href="/Show-all-project"
                                       className="text-gray-600 hover:text-gray-800">Projects</a>
                                </li>
                                <li>
